"""
Grup yönetmenize yardımcı olacak UserBot modülü SakirBey1 tarafından yazıldı ve @SakirBey1 tarafından geliştiriliyor.
"""
...
async def demote(dmod):
    ...
    # Yetki düşürme sonrası yeni izinler izin vermeniz gereklidir 
...
async def ban(bon):
    ...
    # Hedefi yasaklayacağınızı duyurun ama ondan önce komutu yazmanızı temenni ederiz aksi takdirde kod çalışmaz ve hata verir anlayışınız için teşekkürler ..!
    try:
    ...
    # öncelikle yapıldığını söyleyin
...
# Kod Satır bitişi Developer By ŞakirBey 

# Bu kodlamalar tamaman çalınması yasaldır..