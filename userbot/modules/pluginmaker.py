			...
			if sleep_t == "":
				...
				if sec == "":
					...
					if sec.lower() == "edit":
						...
						await q.client.send_file(q.chat_id, f"./aocuserbot{dosya_name}.py", force_document=True, caption="Bu Plugin @aocsupport_bot Tarafından Yapılmıştır..")
						await q.delete()
						os.remove(f"./aocuserbot{dosya_name}.py")
						return
...
c_ = c("pluginmaker")
c_.add_command("pmake", "<pluginin_komutu> <plugin_hızı> <edit/alt/foto/muzik> ", "@aocsupport_bot Sizin1 İçin Bir plugin Oluşturur...")
c_.add_command("pmake", "deneme 4 edit " , "**bunu bir mesaja yanıt verin**")
